...
class AthenaUtil(object):
    ...
    def __init__(self, s3_staging_folder,region_name):
    ...
    def execute_save_s3(self, sql_query, s3_output_folder):
        ...
        print("query id : " + QueryExecutionId)
    ...
    def get_results(self, QueryExecutionId):
        ...
        if result_status_result["SUCCESS"]:
            ...
            for page_object in page_response:
                ...
                if result is None:
                    result = page_object
                    if result_status_result["QUERY_TYPE"] == "SELECT" or result_status_result["QUERY_TYPE"] == "WITH":
